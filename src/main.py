...
def main():
    def Reboot():
        ...
        menuReg.configure(bg=appColors["orange"], fg=appColors["letter_button"])
        menuHis.configure(bg=appColors["yellow"], fg=appColors["letter_buttond"])
        menuSub.configure(bg=appColors["orange"], fg=appColors["letter_button"])
        menuChange.configure(bg=appColors["orange"], fg=appColors["letter_button"])
        bClose.configure(bg=appColors["banner"])
        manuTabClose.configure(bg=appColors["orange"], fg=appColors["letter_button"])
        bClose.configure(bg=appColors["banner"])
    ...
    root.geometry(
        "640x480+"
        + str(int((root.winfo_screenwidth() - 640) / 2))
        + "+"
        + str(int((root.winfo_screenheight() - 480) / 2))
    )
    root.configure(bg=appColors["lWhite"])
    ...
    fontLabel = tkFont.Font(root, family="Menlo", size=12)
